            ...
            return {
                ...
                columns6: [
                    ...
                    },
                    {
                        title:"操作",
                        render:(h,params)=>{
                            var buttonOne = h('button',{
                                attrs:{ type:"button", class:'ivu-btn ivu-btn-primary ivu-btn-circle ivu-btn-icon-only'},
                                on:{
                                    click:function(){
                                        //根据Id获取对应的人员详细信息
                                    ...
                                    h('i',{
                                        attrs:{
                                            class:'ivu-icon ivu-icon-ios-compose'
                                        }
                                    },'')
                                ]);
                            var buttonTwo = h('button',{
                                attrs:{ type:"button", class:'ivu-btn ivu-btn-primary ivu-btn-circle ivu-btn-icon-only'},
                                on:{
                                     click:function(){
                                        //根据Id获取对应的人员详细信息
                            ...
                            return h('div',[buttonOne,buttonTwo])
                        }
                    }
                ],
            }
